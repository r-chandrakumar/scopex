            ...
            child: Padding(
              ...
              child: FutureBuilder<ApiCallResponse>(
                future: (_model
                      ...
                      ..complete(CommonApisGroupGroup.resusersCall.call(
                        authToken: FFAppState().accessToken,
                        domainUrl: FFAppState().DomainUrl,
                        iregex: functions.emptyStringReturn(_model.searchnew),
                      )))
                    .future,
                builder: (context, snapshot) {
                  ...
                  final searchListResusersResponse = snapshot.data!;
                  return Builder(
                    builder: (context) {
                      final res = CommonApisGroupGroup.resusersCall
                              .resUser(
                                searchListResusersResponse.jsonBody,
                              )
                              ?.toList() ??
                          [];
