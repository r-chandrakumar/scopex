...
import 'country_search_model.dart';
export 'country_search_model.dart';
...
class _CountrySearchWidgetState extends State<CountrySearchWidget>
  ...
  late CountrySearchModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CountrySearchModel());
              ...
              child: FutureBuilder<ApiCallResponse>(
                future:
                    (_model.apiRequestCompleter ??= Completer<ApiCallResponse>()
                          ..complete(CommonApisGroupGroup.countryListCall.call(
                ...
                builder: (context, snapshot) {
                  ...
                  final searchListCountryListResponse = snapshot.data!;
                  return Builder(
                    builder: (context) {
                      final countryList = CommonApisGroupGroup.countryListCall
                              .countryLIst(
                                searchListCountryListResponse.jsonBody,
                              )
                              ?.toList() ??
                          [];
                        ...
                        itemBuilder: (context, countryListIndex) {
                          ...
                          return Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                FFAppState().update(() {
                                  FFAppState().CountrySearch = countryListItem;
                                });
