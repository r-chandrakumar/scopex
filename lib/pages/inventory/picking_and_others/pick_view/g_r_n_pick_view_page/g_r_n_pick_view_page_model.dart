...
import 'g_r_n_pick_view_page_widget.dart' show GRNPickViewPageWidget;
...
class GRNPickViewPageModel extends FlutterFlowModel<GRNPickViewPageWidget> {
  ...
  // Stores action output result for [Backend Call - API (Grn View)] action in GRNPick_view_Page widget.
