...
import 'pick_list_search_model.dart';
export 'pick_list_search_model.dart';

class PickListSearchWidget extends StatefulWidget {
  const PickListSearchWidget({Key? key}) : super(key: key);

  @override
  _PickListSearchWidgetState createState() => _PickListSearchWidgetState();
}

class _PickListSearchWidgetState extends State<PickListSearchWidget>
    with TickerProviderStateMixin {
  late PickListSearchModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PickListSearchModel());
            ...
            child: Column(
              ...
              children: [
                FutureBuilder<ApiCallResponse>(
                  future: SearchApiGroupGroup.gRNSearchCall.call(
