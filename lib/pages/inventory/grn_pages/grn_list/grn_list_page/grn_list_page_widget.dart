...
import '/pages/inventory/grn_pages/grn_list/g_r_n_filter_component/g_r_n_filter_component_widget.dart';
...
import 'grn_list_page_model.dart';
export 'grn_list_page_model.dart';

class GrnListPageWidget extends StatefulWidget {
  const GrnListPageWidget({
    Key? key,
    this.state,
  }) : super(key: key);
  ...
  @override
  _GrnListPageWidgetState createState() => _GrnListPageWidgetState();
}

class _GrnListPageWidgetState extends State<GrnListPageWidget> {
  late GrnListPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GrnListPageModel());
                        ...
                        builder: (context) {
                          return GestureDetector(
                            ...
                            child: Padding(
                              ...
                              child: Container(
                                height: MediaQuery.sizeOf(context).height * 0.5,
                                child: GRNFilterComponentWidget(
                                  state: widget.state,
                                ),
                              ),
                            ),
        ...
        body: SafeArea(
          ...
          child: PagedListView<ApiPagingParams, dynamic>.separated(
            pagingController: _model.setListViewController(
              (nextPageMarker) => InventoryApiGroupGroup.grnListCall.call(
            ...
            builderDelegate: PagedChildBuilderDelegate<dynamic>(
              ...
              itemBuilder: (context, _, grnListApiIndex) {
                final grnListApiItem =
                    _model.listViewPagingController!.itemList![grnListApiIndex];
                return Padding(
