...
class GrnListPageModel extends FlutterFlowModel<GrnListPageWidget> {
  ...
  PagingController<ApiPagingParams, dynamic> _createListViewController(
    ...
    return controller..addPageRequestListener(listViewGrnListPage);
  }

  void listViewGrnListPage(ApiPagingParams nextPageMarker) =>
      listViewApiCall!(nextPageMarker).then((listViewGrnListResponse) {
        final pageItems = (InventoryApiGroupGroup.grnListCall.fulldataapi(
                  listViewGrnListResponse.jsonBody,
                )! ??
                [])
            .toList() as List;
        ...
        listViewPagingController?.appendPage(
          ...
          (pageItems.length > 0)
              ? ApiPagingParams(
                  ...
                  lastResponse: listViewGrnListResponse,
                )
              : null,
        );
      });
