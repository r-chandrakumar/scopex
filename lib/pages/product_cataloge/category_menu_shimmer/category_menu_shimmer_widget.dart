...
import 'category_menu_shimmer_model.dart';
export 'category_menu_shimmer_model.dart';

class CategoryMenuShimmerWidget extends StatefulWidget {
  const CategoryMenuShimmerWidget({Key? key}) : super(key: key);

  @override
  _CategoryMenuShimmerWidgetState createState() =>
      _CategoryMenuShimmerWidgetState();
}

class _CategoryMenuShimmerWidgetState extends State<CategoryMenuShimmerWidget>
    with TickerProviderStateMixin {
  late CategoryMenuShimmerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CategoryMenuShimmerModel());
                        ...
                        child: Align(
                          ...
                          child: Transform.rotate(
                            ...
                            child: Image.asset(
                              ...
                              width: MediaQuery.sizeOf(context).width * 0.888,
                              height: 31.0,
                              fit: BoxFit.cover,
                            ).animateOnPageLoad(
                          ...
                          child: Transform.rotate(
                            ...
                            child: Image.asset(
                              ...
                              fit: BoxFit.cover,
                                ...
                                animationsMap['imageOnPageLoadAnimation16']!),
                          ),
                        ),
                      ),
                    ),
