...
import 'category_view_shimmer_model.dart';
export 'category_view_shimmer_model.dart';

class CategoryViewShimmerWidget extends StatefulWidget {
  const CategoryViewShimmerWidget({Key? key}) : super(key: key);

  @override
  _CategoryViewShimmerWidgetState createState() =>
      _CategoryViewShimmerWidgetState();
}

class _CategoryViewShimmerWidgetState extends State<CategoryViewShimmerWidget>
    with TickerProviderStateMixin {
  late CategoryViewShimmerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CategoryViewShimmerModel());
