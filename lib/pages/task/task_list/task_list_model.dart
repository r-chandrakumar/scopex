...
class TaskListModel extends FlutterFlowModel {
  ...
  PagingController<ApiPagingParams, dynamic> _createListViewController(
    ...
    return controller..addPageRequestListener(listViewTaskListViewPage);
  }

  void listViewTaskListViewPage(ApiPagingParams nextPageMarker) =>
      listViewApiCall!(nextPageMarker).then((listViewTaskListViewResponse) {
        final pageItems = (HymechApiGroupGroup.taskListViewCall.projectTask(
                  listViewTaskListViewResponse.jsonBody,
                )! ??
                [])
            .toList() as List;
        ...
        listViewPagingController?.appendPage(
          ...
          (pageItems.length > 0)
              ? ApiPagingParams(
                  ...
                  lastResponse: listViewTaskListViewResponse,
                )
              : null,
        );
      });
