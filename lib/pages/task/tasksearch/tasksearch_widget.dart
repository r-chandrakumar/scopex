...
import 'tasksearch_model.dart';
export 'tasksearch_model.dart';

class TasksearchWidget extends StatefulWidget {
  const TasksearchWidget({Key? key}) : super(key: key);

  @override
  _TasksearchWidgetState createState() => _TasksearchWidgetState();
}

class _TasksearchWidgetState extends State<TasksearchWidget>
    with TickerProviderStateMixin {
  late TasksearchModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TasksearchModel());
                ...
                Padding(
                  ...
                  child: FutureBuilder<ApiCallResponse>(
                    future: (_model.apiRequestCompleter ??= Completer<
                            ApiCallResponse>()
                          ..complete(HymechApiGroupGroup.tasksearchCall.call(
                    ...
                    builder: (context, snapshot) {
                      ...
                      final listViewTasksearchResponse = snapshot.data!;
                      return Builder(
                        builder: (context) {
                          final searchbarchild =
                              HymechApiGroupGroup.tasksearchCall
                                      .searchbarchild(
                                        listViewTasksearchResponse.jsonBody,
                                      )
                                      ?.toList() ??
                                  [];
                          if (searchbarchild.isEmpty) {
                            return Center(
                              child: Image.asset(
                          ...
                          return RefreshIndicator(
                            ...
                            child: ListView.builder(
                              ...
                              itemCount: searchbarchild.length,
                              itemBuilder: (context, searchbarchildIndex) {
                                final searchbarchildItem =
                                    searchbarchild[searchbarchildIndex];
                                return Padding(
