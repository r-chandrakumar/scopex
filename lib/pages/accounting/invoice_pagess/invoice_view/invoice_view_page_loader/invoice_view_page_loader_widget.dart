...
import 'invoice_view_page_loader_model.dart';
export 'invoice_view_page_loader_model.dart';

class InvoiceViewPageLoaderWidget extends StatefulWidget {
  const InvoiceViewPageLoaderWidget({Key? key}) : super(key: key);

  @override
  _InvoiceViewPageLoaderWidgetState createState() =>
      _InvoiceViewPageLoaderWidgetState();
}

class _InvoiceViewPageLoaderWidgetState
    extends State<InvoiceViewPageLoaderWidget> with TickerProviderStateMixin {
  late InvoiceViewPageLoaderModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InvoiceViewPageLoaderModel());
