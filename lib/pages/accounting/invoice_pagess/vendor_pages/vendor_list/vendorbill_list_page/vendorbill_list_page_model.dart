...
import '/pages/accounting/invoice_pagess/vendor_pages/vendor_bill_search/vendor_bill_search_widget.dart';
...
class VendorbillListPageModel extends FlutterFlowModel {
  ...
  PagingController<ApiPagingParams, dynamic> _createListViewController(
    ...
    return controller..addPageRequestListener(listViewVendorBillListPage);
  }

  void listViewVendorBillListPage(ApiPagingParams nextPageMarker) =>
      listViewApiCall!(nextPageMarker).then((listViewVendorBillListResponse) {
        final pageItems =
            (AccountingApiGroupGroup.vendorBillListCall.fulldataapi(
                      listViewVendorBillListResponse.jsonBody,
                    )! ??
                    [])
                .toList() as List;
        ...
        listViewPagingController?.appendPage(
          ...
          (pageItems.length > 0)
              ? ApiPagingParams(
                  ...
                  lastResponse: listViewVendorBillListResponse,
                )
              : null,
        );
      });
