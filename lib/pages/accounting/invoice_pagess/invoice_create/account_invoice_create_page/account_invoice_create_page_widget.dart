...
import 'account_invoice_create_page_model.dart';
export 'account_invoice_create_page_model.dart';

class AccountInvoiceCreatePageWidget extends StatefulWidget {
  const AccountInvoiceCreatePageWidget({Key? key}) : super(key: key);

  @override
  _AccountInvoiceCreatePageWidgetState createState() =>
      _AccountInvoiceCreatePageWidgetState();
}

class _AccountInvoiceCreatePageWidgetState
    extends State<AccountInvoiceCreatePageWidget> {
  late AccountInvoiceCreatePageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AccountInvoiceCreatePageModel());
