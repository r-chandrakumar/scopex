...
class CreateLeadWidget extends StatefulWidget {
  const CreateLeadWidget({Key? key}) : super(key: key);

  @override
  _CreateLeadWidgetState createState() => _CreateLeadWidgetState();
}
...
class _CreateLeadWidgetState extends State<CreateLeadWidget> {
  ...
  void initState() {
    ...
    _model.leadnameController ??= TextEditingController();
    _model.emailController ??= TextEditingController();
    _model.numberController ??= TextEditingController();
    _model.customerPersonController ??= TextEditingController();
    _model.expectedrevenueController ??= TextEditingController();
    _model.probabilityController ??= TextEditingController();
                                                      ...
                                                      decoration:
                                                        ...
                                                        hintText:
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                          'nh32tth1' /* Enter Customer Mobile Number */,
                                                        ),
                                                        hintStyle:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                              ...
                                                              child:
                                                                ...
                                                                decoration:
                                                                  ...
                                                                  hintText: FFLocalizations.of(
                                                                          context)
                                                                      .getText(
                                                                    'e3uaqi4j' /* Enter Customer Person */,
                                                                  ),
                                              ...
                                              decoration: InputDecoration(
                                                ...
                                                hintText:
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                  'nh76s1dk' /* Enter Customer Address */,
                                                ),
                                                hintStyle:
                                                    FlutterFlowTheme.of(context)
                                                        .labelMedium
                                  ...
                                  onPressed: () async {
                                    ...
                                    _model.leadCreateResult =
                                      ...
                                      sourceId: functions.changeStringToInt(
                                          _model.listsourceValue),
                                      contactName:
                                          _model.customerPersonController.text,
                                      domainUrl: FFAppState().DomainUrl,
                                    );
                                    if ((_model.leadCreateResult?.succeeded ??
                                        true)) {
