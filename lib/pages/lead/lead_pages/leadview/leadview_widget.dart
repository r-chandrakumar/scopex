...
import 'leadview_model.dart';
export 'leadview_model.dart';

class LeadviewWidget extends StatefulWidget {
  const LeadviewWidget({
    Key? key,
  ...
  @override
  _LeadviewWidgetState createState() => _LeadviewWidgetState();
}

class _LeadviewWidgetState extends State<LeadviewWidget> {
  late LeadviewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LeadviewModel());
              ...
              children: [
                FutureBuilder<ApiCallResponse>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    if (!snapshot.hasData) {
                      return LeadviewShimmerWidget();
                    }
                    final containerCrmViewResponse = snapshot.data!;
                    return Container(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      children: [
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                              Text(
                                                                            functions.listphone(HymechApiGroupGroup.crmViewCall
                                                                                .mobile(
                                                                                  containerCrmViewResponse.jsonBody,
                                                                                )
                                                                                .toString())!,
                                                                        ...
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            valueOrDefault<String>(
                                                                              functions.isNull(HymechApiGroupGroup.crmViewCall
                                                                                  .email(
                                                                                    containerCrmViewResponse.jsonBody,
                                                                                  )
                                                                                  .toString()),
                                                                                  ...
                                                                                  children: [
                                                                                    Row(
                                                                                      ...
                                                                                      children: [
                                                                                        Expanded(
                                                                                          child: Text(
                                                                                            'Contact via ${functions.isNull(getJsonField(
                                                                                              activityItem,
                                                                                              r'''$.mail_activity_type.name''',
                                                                                            ).toString())} - ${functions.isNull(getJsonField(
                                                                                              activityItem,
                                                                                              r'''$.summary''',
                                                                                            ).toString())}',
                                                                                            style: FlutterFlowTheme.of(context).bodyMedium,
