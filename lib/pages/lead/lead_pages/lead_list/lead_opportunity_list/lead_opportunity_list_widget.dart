...
export 'lead_opportunity_list_model.dart';

class LeadOpportunityListWidget extends StatefulWidget {
  const LeadOpportunityListWidget({
    Key? key,
  ...
  @override
  _LeadOpportunityListWidgetState createState() =>
      _LeadOpportunityListWidgetState();
}

class _LeadOpportunityListWidgetState extends State<LeadOpportunityListWidget>
    with TickerProviderStateMixin {
  late LeadOpportunityListModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LeadOpportunityListModel());
        ...
        body: SafeArea(
          ...
          child: FutureBuilder<ApiCallResponse>(
            future: (_model.apiRequestCompleter ??= Completer<ApiCallResponse>()
                  ..complete(HymechApiGroupGroup.myOpportunityCall.call(
            ...
            builder: (context, snapshot) {
              ...
              final listViewMyOpportunityResponse = snapshot.data!;
              return Builder(
                builder: (context) {
                  final crmlead = HymechApiGroupGroup.myOpportunityCall
                          .crmlead(
                            listViewMyOpportunityResponse.jsonBody,
                          )
                          ?.toList() ??
                      [];
                  if (crmlead.isEmpty) {
