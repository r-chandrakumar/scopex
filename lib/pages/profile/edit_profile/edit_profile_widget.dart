            ...
            children: [
              ...
              Padding(
                ...
                child: SelectionArea(
                    child: Text(
                  FFLocalizations.of(context).getText(
                    'vruutmmm' /* The email associated with this... */,
                  ),
              ...
              Padding(
                padding: EdgeInsetsDirectional.fromSTEB(25.0, 4.0, 0.0, 0.0),
                child: SelectionArea(
                    child: Text(
                  FFLocalizations.of(context).getText(
                    '51fdcoln' /* The email associated with this... */,
                  ),
                ...
                child: Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      ...
                      _model.result =
                          await HymechApiGroupGroup.myProfileEditCall.call(
