...
import 'noactivity_model.dart';
export 'noactivity_model.dart';

class NoactivityWidget extends StatefulWidget {
  const NoactivityWidget({Key? key}) : super(key: key);

  @override
  _NoactivityWidgetState createState() => _NoactivityWidgetState();
}
