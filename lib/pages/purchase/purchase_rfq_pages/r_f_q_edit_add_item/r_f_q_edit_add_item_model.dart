...
import 'r_f_q_edit_add_item_widget.dart' show RFQEditAddItemWidget;
...
class RFQEditAddItemModel extends FlutterFlowModel<RFQEditAddItemWidget> {
  ///  State fields for stateful widgets in this component.

  final formKey = GlobalKey<FormState>();
  // Stores action output result for [Backend Call - API (Product Detail)] action in RFQ_Edit_Add_item widget.
  ...
  // Stores action output result for [Backend Call - API (Purchase Order Line Product Create)] action in Button widget.
  ...
  // Stores action output result for [Backend Call - API (Purchase Order Line Product Create)] action in Button widget.
  ApiCallResponse? resSaveandNewSave;
  // Stores action output result for [Backend Call - API (Purchase Order View)] action in Button widget.
  ApiCallResponse? updationDetailForTotalinsave;
