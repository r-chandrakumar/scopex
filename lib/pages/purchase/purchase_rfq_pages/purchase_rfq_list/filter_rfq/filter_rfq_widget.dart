...
import 'filter_rfq_model.dart';
export 'filter_rfq_model.dart';

class FilterRfqWidget extends StatefulWidget {
  const FilterRfqWidget({
    Key? key,
    required this.state,
    this.startdate,
    this.enddate,
  ...
  @override
  _FilterRfqWidgetState createState() => _FilterRfqWidgetState();
}

class _FilterRfqWidgetState extends State<FilterRfqWidget> {
  late FilterRfqModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FilterRfqModel());
