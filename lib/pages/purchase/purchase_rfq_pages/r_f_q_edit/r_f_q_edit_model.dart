...
import 'r_f_q_edit_widget.dart' show RFQEditWidget;
...
class RFQEditModel extends FlutterFlowModel<RFQEditWidget> {
  ///  State fields for stateful widgets in this page.

  final unfocusNode = FocusNode();
  final formKey = GlobalKey<FormState>();
  // Stores action output result for [Backend Call - API (Purchase Order View)] action in RFQ_edit widget.
  ApiCallResponse? purchaseViewRes;
  // Stores action output result for [Backend Call - API (Get Customer Details)] action in RFQ_edit widget.
  ...
  // Stores action output result for [Backend Call - API (Purchase Order Update)] action in Button widget.
  ApiCallResponse? purchaseOrderUpdateRes;
