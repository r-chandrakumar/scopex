                ...
                child: FutureBuilder<ApiCallResponse>(
                  future: (_model.apiRequestCompleter ??=
                          Completer<ApiCallResponse>()
                            ..complete(HymechApiGroupGroup.projectListCall.call(
                  ...
                  builder: (context, snapshot) {
                    ...
                    final listViewProjectListResponse = snapshot.data!;
                    return Builder(
                      builder: (context) {
                        final project = getJsonField(
                          listViewProjectListResponse.jsonBody,
                          r'''$.project_project''',
                        ).toList();
                        if (project.isEmpty) {
                          return Image.asset(
