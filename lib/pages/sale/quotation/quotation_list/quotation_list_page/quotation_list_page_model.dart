...
class QuotationListPageModel extends FlutterFlowModel {
  ...
  PagingController<ApiPagingParams, dynamic> _createListViewController(
    ...
    return controller..addPageRequestListener(listViewQuotationListPage);
  }

  void listViewQuotationListPage(ApiPagingParams nextPageMarker) =>
      listViewApiCall!(nextPageMarker).then((listViewQuotationListResponse) {
        final pageItems =
            (SalesApiGroupGroup.quotationListCall.saleOrderFullList(
                      listViewQuotationListResponse.jsonBody,
                    )! ??
                    [])
                .toList() as List;
        ...
        listViewPagingController?.appendPage(
          ...
          (pageItems.length > 0)
              ? ApiPagingParams(
                  ...
                  lastResponse: listViewQuotationListResponse,
                )
              : null,
        );
      });
