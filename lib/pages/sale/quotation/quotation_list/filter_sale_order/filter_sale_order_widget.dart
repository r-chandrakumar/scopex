...
import 'filter_sale_order_model.dart';
export 'filter_sale_order_model.dart';

class FilterSaleOrderWidget extends StatefulWidget {
  const FilterSaleOrderWidget({
    Key? key,
    required this.state,
    this.startdate,
    this.enddate,
  ...
  @override
  _FilterSaleOrderWidgetState createState() => _FilterSaleOrderWidgetState();
}

class _FilterSaleOrderWidgetState extends State<FilterSaleOrderWidget> {
  late FilterSaleOrderModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FilterSaleOrderModel());
