...
import 'filter_quotations_model.dart';
export 'filter_quotations_model.dart';

class FilterQuotationsWidget extends StatefulWidget {
  const FilterQuotationsWidget({
    Key? key,
    required this.state,
    this.startdate,
    this.enddate,
  ...
  @override
  _FilterQuotationsWidgetState createState() => _FilterQuotationsWidgetState();
}

class _FilterQuotationsWidgetState extends State<FilterQuotationsWidget> {
  late FilterQuotationsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FilterQuotationsModel());
