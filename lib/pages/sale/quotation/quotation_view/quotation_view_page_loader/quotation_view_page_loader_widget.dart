...
import 'quotation_view_page_loader_model.dart';
export 'quotation_view_page_loader_model.dart';

class QuotationViewPageLoaderWidget extends StatefulWidget {
  const QuotationViewPageLoaderWidget({Key? key}) : super(key: key);

  @override
  _QuotationViewPageLoaderWidgetState createState() =>
      _QuotationViewPageLoaderWidgetState();
}

class _QuotationViewPageLoaderWidgetState
    extends State<QuotationViewPageLoaderWidget> with TickerProviderStateMixin {
  late QuotationViewPageLoaderModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => QuotationViewPageLoaderModel());
