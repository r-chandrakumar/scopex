...
import 'sale_order_view_page_loader_model.dart';
export 'sale_order_view_page_loader_model.dart';

class SaleOrderViewPageLoaderWidget extends StatefulWidget {
  const SaleOrderViewPageLoaderWidget({Key? key}) : super(key: key);

  @override
  _SaleOrderViewPageLoaderWidgetState createState() =>
      _SaleOrderViewPageLoaderWidgetState();
}

class _SaleOrderViewPageLoaderWidgetState
    extends State<SaleOrderViewPageLoaderWidget> with TickerProviderStateMixin {
  late SaleOrderViewPageLoaderModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SaleOrderViewPageLoaderModel());
