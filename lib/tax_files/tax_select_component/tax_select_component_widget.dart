                      ...
                      child: Padding(
                        ...
                        child: TextFormField(
                          ...
                          onChanged: (_) => EasyDebounce.debounce(
                            ...
                            () async {
                              setState(() {
                                _model.search = functions
                                    .emptyfunction(_model.textController.text);
                              });
            ...
            Padding(
              ...
              child: FutureBuilder<ApiCallResponse>(
                ...
                builder: (context, snapshot) {
                  ...
                  return Builder(
                    builder: (context) {
                      final taxList = CommonApisGroupGroup.taxListWithSearchCall
                              .taxList(
                                listViewTaxListWithSearchResponse.jsonBody,
                              )
                              ?.toList() ??
                          [];
                            ...
                            child: Row(
                              ...
                              children: [
                                Theme(
                                  ...
                                  child: Checkbox(
                                    value:
                                        _model.checkboxValueMap[taxListItem] ??=
