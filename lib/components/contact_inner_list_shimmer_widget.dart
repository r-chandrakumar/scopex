...
import 'contact_inner_list_shimmer_model.dart';
export 'contact_inner_list_shimmer_model.dart';

class ContactInnerListShimmerWidget extends StatefulWidget {
  const ContactInnerListShimmerWidget({Key? key}) : super(key: key);

  @override
  _ContactInnerListShimmerWidgetState createState() =>
      _ContactInnerListShimmerWidgetState();
}

class _ContactInnerListShimmerWidgetState
    extends State<ContactInnerListShimmerWidget> with TickerProviderStateMixin {
  late ContactInnerListShimmerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ContactInnerListShimmerModel());
