...
import 'contac_view_shimmer_model.dart';
export 'contac_view_shimmer_model.dart';

class ContacViewShimmerWidget extends StatefulWidget {
  const ContacViewShimmerWidget({Key? key}) : super(key: key);

  @override
  _ContacViewShimmerWidgetState createState() =>
      _ContacViewShimmerWidgetState();
}

class _ContacViewShimmerWidgetState extends State<ContacViewShimmerWidget>
    with TickerProviderStateMixin {
  late ContacViewShimmerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ContacViewShimmerModel());
