...
import 'contact_list_shimmer_model.dart';
export 'contact_list_shimmer_model.dart';

class ContactListShimmerWidget extends StatefulWidget {
  const ContactListShimmerWidget({Key? key}) : super(key: key);

  @override
  _ContactListShimmerWidgetState createState() =>
      _ContactListShimmerWidgetState();
}

class _ContactListShimmerWidgetState extends State<ContactListShimmerWidget>
    with TickerProviderStateMixin {
  late ContactListShimmerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ContactListShimmerModel());
