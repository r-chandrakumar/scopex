...
import 'task_details_dashboard1_model.dart';
export 'task_details_dashboard1_model.dart';

class TaskDetailsDashboard1Widget extends StatefulWidget {
  const TaskDetailsDashboard1Widget({Key? key}) : super(key: key);

  @override
  _TaskDetailsDashboard1WidgetState createState() =>
      _TaskDetailsDashboard1WidgetState();
}

class _TaskDetailsDashboard1WidgetState
    extends State<TaskDetailsDashboard1Widget> with TickerProviderStateMixin {
  late TaskDetailsDashboard1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TaskDetailsDashboard1Model());
