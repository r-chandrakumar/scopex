...
import 'appspshimmer_model.dart';
export 'appspshimmer_model.dart';

class AppspshimmerWidget extends StatefulWidget {
  const AppspshimmerWidget({Key? key}) : super(key: key);

  @override
  _AppspshimmerWidgetState createState() => _AppspshimmerWidgetState();
}

class _AppspshimmerWidgetState extends State<AppspshimmerWidget>
    with TickerProviderStateMixin {
  late AppspshimmerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AppspshimmerModel());
